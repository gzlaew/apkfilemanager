        ...
        <div class="navbar-vertical-content">
          <ul class="navbar-nav flex-column" id="navbarVerticalNav">
            <li class="nav-item">
              ...
              <div class="nav-item-wrapper"><a class="nav-link label-1" href="index.php?pages=dokumen&aksi=tampil" role="button" data-bs-toggle="" aria-expanded="false">
        ...
        <div class="navbar-logo">
          ...
          <a class="navbar-brand me-1 me-sm-3" href="index.php">
            <div class="d-flex align-items-center">
              <div class="d-flex align-items-center"><img src="../foto/<?php echo $DATA['logo']; ?>" alt="phoenix" width="27" />
        ...
        <footer class="footer position-absolute">
          <div class="row g-0 justify-content-between align-items-center h-100">
            <div class="col-12 col-sm-auto text-center">
              <p class="mb-0 mt-2 mt-sm-0 text-900"><?php echo $DATA['footer']; ?></p>
            </div>
            <div class="col-12 col-sm-auto text-center">
